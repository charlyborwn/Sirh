...
public class cVDocumConsola extends javax.swing.JFrame {


    public cVDocumConsola() {
        initComponents();
        setResizable(false);
    ...
    private void Iniciar(){
        try {
            txtPath.setText(cDocum.getPathUsuario());
            Image icon=new javax.swing.ImageIcon(new URL(cDocum.getPathUsuario())).getImage().getScaledInstance(imgPath.getWidth(), imgPath.getWidth(), Image.SCALE_DEFAULT);
            Icon imagen=new ImageIcon(icon);
            imgPath.setIcon(imagen);
        } catch (MalformedURLException ex) {
            Logger.getLogger(cVDocumConsola.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cVDocumConsola.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cVDocumConsola().setVisible(true);
            }
        });
    }
