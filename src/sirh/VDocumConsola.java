...
public class VDocumConsola extends javax.swing.JFrame {


    public VDocumConsola() {
        initComponents();
        setResizable(false);
    ...
    private void Iniciar(){
        try {
            txtPath.setText(Docum.getPathUsuario());
            Image icon=new javax.swing.ImageIcon(new URL(Docum.getPathUsuario())).getImage().getScaledInstance(imgPath.getWidth(), imgPath.getWidth(), Image.SCALE_DEFAULT);
            Icon imagen=new ImageIcon(icon);
            imgPath.setIcon(imagen);
        } catch (MalformedURLException ex) {
            Logger.getLogger(VDocumConsola.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VDocumConsola.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VDocumConsola().setVisible(true);
            }
        });
    }
