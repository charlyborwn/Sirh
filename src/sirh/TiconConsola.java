...
public class TiconConsola extends javax.swing.JFrame {
    ...
    private void Iniciar(){
        Limpiar(tablaticon);
        DefaultTableModel modelo=(DefaultTableModel) tablaticon.getModel();
        Ticon e=new Ticon();
    ...
    private void initComponents() {
        ...
        tablaticon1 = new javax.swing.JTable();
        jLabel6 = new javax.swing.JLabel();
        busqueda = new javax.swing.JTextField();
        salir1 = new javax.swing.JButton();
        jPanel2 = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        tablaticon = new javax.swing.JTable();
        ...
        tablaticon1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Clave", "Descripción", "Status", "Ultima Fecha", "Ultimo Usuario"
            }
        ) {
        ...
        tablaticon1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablaticon1MouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tablaticon1);
        ...
        tablaticon.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablaticon.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablaticonMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tablaticon);
        ...
        jLabel1.setText("CATALOGO DE TIPOS DE CONTRATOS");
    ...
    private void crearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_crearActionPerformed
        ...
        e.Agregar(descl, desde, Acceso.getClaveUsuario());
    ...
    private void actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actualizarActionPerformed
        Ticon e=new Ticon();
        e.Actualizar(clave.getText().toUpperCase(), descripcion.getText().toUpperCase(), Acceso.getClaveUsuario());
        JOptionPane.showMessageDialog(this, "Registro actualizar .....");
        Iniciar();
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Registro eliminar .....");
        Iniciar();
    ...
    private void tablaticonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaticonMouseClicked
        DefaultTableModel modelo= (DefaultTableModel) tablaticon.getModel();
        clave.setText(modelo.getValueAt(tablaticon.getSelectedRow(), 0)+"");
        descripcion.setText(modelo.getValueAt(tablaticon.getSelectedRow(), 1)+"");
        fecha.setText(modelo.getValueAt(tablaticon.getSelectedRow(), 3)+"");
        usuario.setText(modelo.getValueAt(tablaticon.getSelectedRow(), 4)+"");
        crear.setEnabled(false);
        clave.setEnabled(false);
    }//GEN-LAST:event_tablaticonMouseClicked

    private void tablaticon1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaticon1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tablaticon1MouseClicked
    ...
    private void busquedaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_busquedaKeyPressed
        Ticon e=new Ticon();
        Limpiar(tablaticon1);
        DefaultTableModel modelo= (DefaultTableModel) tablaticon1.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TiconConsola.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TiconConsola().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tablaticon;
    private javax.swing.JTable tablaticon1;
