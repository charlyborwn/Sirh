...
public class cEscolAConsola extends javax.swing.JFrame {


    public cEscolAConsola() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BUSQUEDA DE ESCOLARIDADES (Aspirantes)");
    ...
    private void pathMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pathMouseClicked
        cEscolA.setPathUsuario(path.getText().toUpperCase());
        cVEscolAConsola object=new cVEscolAConsola();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cEscolAConsola.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cEscolAConsola().setVisible(true);
            }
        });
    }
