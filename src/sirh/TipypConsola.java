...
public class TipypConsola extends javax.swing.JFrame {
    ...
    private void Iniciar(){
        Limpiar(tablatipyp);
        DefaultTableModel modelo=(DefaultTableModel) tablatipyp.getModel();
        Tipyp e=new Tipyp();
    ...
    private void initComponents() {
        ...
        tablatipyp1 = new javax.swing.JTable();
        jLabel6 = new javax.swing.JLabel();
        busqueda = new javax.swing.JTextField();
        salir1 = new javax.swing.JButton();
        jPanel2 = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        tablatipyp = new javax.swing.JTable();
        ...
        tablatipyp1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Descripción", "Clave Empresa", "Nombre Empresa", "Status", "Ultima Fecha", "Ultimo Usuario"
            }
        ) {
        ...
        tablatipyp1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablatipyp1MouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tablatipyp1);
        ...
        tablatipyp.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablatipyp.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablatipypMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tablatipyp);
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(cveempresa, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(empresa, javax.swing.GroupLayout.PREFERRED_SIZE, 281, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel1.setText("CATALOGO DE TIPOS DE PREMIOS Y PRESTACIONES");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtNombre, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 352, Short.MAX_VALUE)
    ...
    private void crearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_crearActionPerformed
        ...
        if(desde.isEmpty()){
            JOptionPane.showMessageDialog(this, "Se requiere una descripción, verifique .....");
            Iniciar();
        }
        else{
            String desce=cveempresa.getSelectedItem().toString();
            String desem=empresa.getText().toUpperCase();
            e.Agregar(desde, desce, desem, Acceso.getClaveUsuario());
    ...
    private void actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actualizarActionPerformed
        ...
        String desce=cveempresa.getSelectedItem().toString();
        String desem=empresa.getText().toUpperCase();
        e.Actualizar(desde, desce, desem, Acceso.getClaveUsuario());
    ...
    private void tablatipypMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablatipypMouseClicked
        DefaultTableModel modelo= (DefaultTableModel) tablatipyp.getModel();
        descripcion.setText(modelo.getValueAt(tablatipyp.getSelectedRow(), 0)+"");
        cveempresa.setSelectedItem(modelo.getValueAt(tablatipyp.getSelectedRow(), 1)+"");
        empresa.setText(modelo.getValueAt(tablatipyp.getSelectedRow(), 2)+"");
        fecha.setText(modelo.getValueAt(tablatipyp.getSelectedRow(), 4)+"");
        usuario.setText(modelo.getValueAt(tablatipyp.getSelectedRow(), 5)+"");
        crear.setEnabled(false);
        descripcion.setEnabled(false);
    }//GEN-LAST:event_tablatipypMouseClicked

    private void tablatipyp1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablatipyp1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tablatipyp1MouseClicked
    ...
    private void busquedaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_busquedaKeyPressed
        Tipyp e=new Tipyp();
        Limpiar(tablatipyp1);
        DefaultTableModel modelo= (DefaultTableModel) tablatipyp1.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipypConsola.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TipypConsola().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tablatipyp;
    private javax.swing.JTable tablatipyp1;
