...
public class cBenefConsola extends javax.swing.JFrame {


    public cBenefConsola() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BUSQUEDA DE BENEFICIARIOS (Trabajadores)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cBenefConsola.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cBenefConsola().setVisible(true);
            }
        });
    }
