...
public class VContrConsola extends javax.swing.JFrame {


    public VContrConsola() {
        initComponents();
        setResizable(false);
    ...
    private void Iniciar(){
        try {
            txtPath.setText(Contr.getPathUsuario());
            Image icon=new javax.swing.ImageIcon(new URL(Contr.getPathUsuario())).getImage().getScaledInstance(imgPath.getWidth(), imgPath.getWidth(), Image.SCALE_DEFAULT);
            Icon imagen=new ImageIcon(icon);
            imgPath.setIcon(imagen);
        } catch (MalformedURLException ex) {
            Logger.getLogger(VContrConsola.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VContrConsola.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VContrConsola().setVisible(true);
            }
        });
    }
