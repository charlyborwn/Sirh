...
public class NacioConsola extends javax.swing.JFrame {
    ...
    private void Iniciar(){
        Limpiar(tablanacio);
        DefaultTableModel modelo=(DefaultTableModel) tablanacio.getModel();
        Nacio e=new Nacio();
    ...
    private void initComponents() {
        ...
        tablanacio1 = new javax.swing.JTable();
        jLabel5 = new javax.swing.JLabel();
        busqueda = new javax.swing.JTextField();
        salir1 = new javax.swing.JButton();
        jPanel2 = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        tablanacio = new javax.swing.JTable();
        ...
        tablanacio1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Nacionalidad", "Status", "Ultima Fecha", "Ultimo Usuario"
            }
        ) {
        ...
        tablanacio1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablanacio1MouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tablanacio1);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(salir1, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        ...
        tablanacio.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablanacio.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablanacioMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tablanacio);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(nacio, javax.swing.GroupLayout.PREFERRED_SIZE, 274, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(usuario, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE)
        ...
        jLabel1.setText("CATALOGO DE NACIONALIDADES");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGap(36, 36, 36)
                .addComponent(jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 298, Short.MAX_VALUE)
                .addGap(3, 3, 3))
        );
    ...
    private void tablanacioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablanacioMouseClicked
        DefaultTableModel modelo= (DefaultTableModel) tablanacio.getModel();
        nacio.setText(modelo.getValueAt(tablanacio.getSelectedRow(), 0)+"");
        fecha.setText(modelo.getValueAt(tablanacio.getSelectedRow(), 2)+"");
        usuario.setText(modelo.getValueAt(tablanacio.getSelectedRow(), 3)+"");
        crear.setEnabled(false);
        nacio.setEnabled(false);
    }//GEN-LAST:event_tablanacioMouseClicked

    private void tablanacio1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablanacio1MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tablanacio1MouseClicked
    ...
    private void crearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_crearActionPerformed
        Nacio e=new Nacio();
        String desna=nacio.getText().toUpperCase();
        e.Agregar(desna, Acceso.getClaveUsuario());
    ...
    private void actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actualizarActionPerformed
        Nacio e=new Nacio();
        e.Actualizar(nacio.getText().toUpperCase(), Acceso.getClaveUsuario());
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        Nacio e=new Nacio();
        e.Eliminar(nacio.getText().toUpperCase(), Acceso.getClaveUsuario());
    ...
    private void busquedaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_busquedaKeyPressed
        Nacio e=new Nacio();
        Limpiar(tablanacio1);
        DefaultTableModel modelo= (DefaultTableModel) tablanacio1.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NacioConsola.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NacioConsola().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tablanacio;
    private javax.swing.JTable tablanacio1;
